...
/** Placeholder — pemilih kriteria klasifikasi (FR-10, Fase 3) */
export default function KelompokkanPage() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-4 py-12 text-center">
      ...
      <h1 className="text-2xl font-bold text-text-primary mb-2">Kelompokkan Bangun</h1>
      <p className="text-text-secondary mb-6 max-w-md">
        Halaman ini sedang dalam pengembangan.
        <br />
        Akan menampilkan Classification Sandbox untuk mengelompokkan bangun.
      </p>
      <Link
        href="/"
