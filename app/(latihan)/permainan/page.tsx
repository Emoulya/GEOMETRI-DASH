...
/** Placeholder — daftar mini game (FR-18, Fase 5) */
export default function PermainanPage() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-4 py-12 text-center">
      ...
      <h1 className="text-2xl font-bold text-text-primary mb-2">Permainan</h1>
      <p className="text-text-secondary mb-6 max-w-md">
        Halaman ini sedang dalam pengembangan.
        <br />
        Akan menampilkan 4 mini game dengan tujuan pembelajaran.
      </p>
      <Link
        href="/"
